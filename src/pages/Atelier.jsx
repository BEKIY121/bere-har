...
const Atelier = () => {
  ...
  return (
    <section style={{ paddingTop: '15vh', minHeight: '100vh', backgroundColor: 'var(--bg-cream)' }}>
      <div className="container">
        ...
        >
          <p className="script-font" style={{ fontSize: '3rem', color: 'var(--text-muted)' }}>The Process</p>
          <h1 style={{ fontSize: '4rem', marginTop: '-1rem' }}>Atelier</h1>
        </motion.div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6rem', maxWidth: '800px', margin: '0 auto' }}>
          {steps.map((step, idx) => (
            <motion.div 
              ...
              style={{ display: 'grid', gridTemplateColumns: '100px 1fr', gap: '3rem', alignItems: 'baseline' }}
            >
              <h2 style={{ fontSize: '4rem', color: 'rgba(26,26,26,0.1)', fontFamily: 'Inter, sans-serif', fontWeight: '800' }}>
                {step.num}
              </h2>
              <div>
